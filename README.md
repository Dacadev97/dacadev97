...
Fundador y Lead Engineer en **[TechDX](https://techdx.com.co)** (*Design & Xperience*). Especializado en diseñar y construir sistemas distribuidos en la nube, plataformas SaaS multi-tenant y arquitecturas web de alto rendimiento con criterio de producto y diseño impecable.
...
| Proyecto | Tipo | Stack & Arquitectura | Live Demo |
| :--- | :--- | :--- | :--- |
| **[Kinetix OS](https://kinetix-os.app)** | SaaS Multi-Tenant | AWS ECS Fargate, Aurora Postgres Serverless v2, Laravel, Wompi COP | [🚀 Ver Plataforma](https://kinetix-os.app) |
| **[Roomly PMS](https://hotelgalan.techdx.com.co)** | PMS Hotelero Cloud | Laravel, MySQL, Docker, Facturación DIAN, Cierre de Caja 1-Clic | [🏨 Ver Sistema](https://hotelgalan.techdx.com.co) |
| **[TechDX Core](https://techdx.com.co)** | Web & Brand Hub | Astro 5, Three.js 3D Procedural, Tailwind CSS, Resend API | [🌐 Ver Sitio Web](https://techdx.com.co) |
| **[Velocce Athletics](https://velocce.techdx.com.co)** | E-commerce & Kiosko | Filament, PWA Offline, Pasarela Wompi Bancolombia | [⚡ Ver Kiosko](https://velocce.techdx.com.co) |
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Filament_PHP-EAB308?style=flat-square&logo=filament&logoColor=white" />
  <br />

  <!-- Cloud, Bases de Datos & DevOps -->
...
<div align="center">
  <sub>Construido con ingeniería y pasión por <b>Davidson Cadavid</b> · © 2026 TechDX · Colombia</sub>
</div>
